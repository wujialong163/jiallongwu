/* /home/wujialong/mpiP-3.5/mpiP-wrappers.c */
/* DO NOT EDIT -- AUTOMATICALLY GENERATED! */
/* Timestamp: 07 May 2023 19:57  */
/* Location: wujialong-virtual-machine posix */
/* Creator: wujialong  */
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Accumulate ,mpiPi.rank, call_stack, start, end, mpiPi.rank , * target_rank,dur, (double)messSize,(double)ioSize,(double)rmaSize);

  mpiPi_update_test(start, end, mpiPi.rank , * target_rank, hndl,
         mpiPi_MPI_Accumulate, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl,  mpiPi_MPI_Allgather, mpiPi.rank, call_stack, start, end, -2,-2);

  mpiPi_update_test(start, end,-1, -1, hndl,
         mpiPi_MPI_Allgather, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl,  mpiPi_MPI_Allgatherv, mpiPi.rank, call_stack, start, end, -2, -2);

  mpiPi_update_test(start, end,-1, -1, hndl,
         mpiPi_MPI_Allgatherv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Allreduce, mpiPi.rank, call_stack, start, end ,-2, -2);

  mpiPi_update_test(start, end,-1, -1, hndl,
         mpiPi_MPI_Allreduce, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Alltoall, mpiPi.rank, call_stack, start, end, -2, -2);

  mpiPi_update_test(start, end,-1, -1, hndl,
         mpiPi_MPI_Alltoall, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Alltoallv, mpiPi.rank, call_stack, start, end, -2, -2);

  mpiPi_update_test(start, end,-1, -1, hndl,
         mpiPi_MPI_Alltoallv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Barrier, mpiPi.rank,call_stack, start, end, -1 , -1);

  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Barrier, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Bcast, mpiPi.rank, call_stack, start, end, * root , mpiPi.rank);

  mpiPi_update_test(start, end,* root , mpiPi.rank, hndl,
         mpiPi_MPI_Bcast, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Bsend, mpiPi.rank, call_stack, start, end, mpiPi.rank, * dest);

  mpiPi_update_test(start, end,mpiPi.rank, * dest, hndl,
         mpiPi_MPI_Bsend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Bsend_init, mpiPi.rank, call_stack, start, end, -1,-1);

  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Bsend_init, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Buffer_attach, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Buffer_attach, mpiPi.rank, call_stack, start, end, -1, -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Buffer_detach, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Buffer_detach, mpiPi.rank, call_stack,start ,end, -1,-1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cancel, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cancel, mpiPi.rank, call_stack, start, end, -1, -1);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_coords, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_coords, mpiPi.rank, call_stack,start, end, -1, -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_create, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_create, mpiPi.rank, call_stack,start, end, -1 , -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_get, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_get, mpiPi.rank, call_stack, start, end, -1, -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_map, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_map, mpiPi.rank, call_stack, start, end , -1, -1,(double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_rank, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_rank, mpiPi.rank, call_stack, start , end , -1 ,-1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_shift, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_shift, mpiPi.rank, call_stack, start, end, -1, -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cart_sub, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Cart_sub, mpiPi.rank, call_stack, start, end, -1 ,-1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Cartdim_get, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_create, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_create_keyval, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_delete_attr, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_dup, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Comm_dup, mpiPi.rank,call_stack, start, end ,-1, -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_free, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_free_keyval, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_get_attr, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_group, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_remote_group, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_remote_size, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_set_attr, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_split, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Comm_test_inter, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Compare_and_swap, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Dims_create, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Error_class, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Fetch_and_op, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_close, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_delete, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_amode, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_byte_offset, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_group, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_info, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_position, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_size, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_get_view, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_open, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_preallocate, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_read, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_read_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_read_at, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_read_at_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_seek, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_set_info, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_set_size, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_set_view, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_sync, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_write, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_write_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_write_at, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_File_write_at_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,mpiPi.rank, * root, hndl,
         mpiPi_MPI_Gather, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Gatherv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Get, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Get_accumulate, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Graph_create, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Graph_get, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Graph_map, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Graph_neighbors, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Graph_neighbors_count, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Graphdims_get, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_compare, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_difference, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_excl, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_free, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_incl, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_intersection, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_translate_ranks, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Group_union, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iallgather, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iallgatherv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iallreduce, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ialltoall, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ialltoallv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ialltoallw, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ibarrier, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ibcast, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ibsend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iexscan, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Igather, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Igatherv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Intercomm_create, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Intercomm_merge, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iprobe, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Irecv, mpiPi.rank, call_stack, start, end, *source, mpiPi.rank);
  
  mpiPi_update_test(start, end,*source, mpiPi.rank, hndl,
         mpiPi_MPI_Irecv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,* root, mpiPi.rank, hndl,
         mpiPi_MPI_Ireduce, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ireduce_scatter, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ireduce_scatter_block, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Irsend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iscan, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Iscatter, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,* root, mpiPi.rank, hndl,
         mpiPi_MPI_Iscatterv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Isend, mpiPi.rank, call_stack, start, end, mpiPi.rank, * dest);

  mpiPi_update_test(start, end,mpiPi.rank, * dest, hndl,
         mpiPi_MPI_Isend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,mpiPi.rank, * dest, hndl,
         mpiPi_MPI_Issend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Pack, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Probe, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Put, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Raccumulate, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( *datatype != MPI_DATATYPE_NULL ) { 
  PMPI_Type_size(*datatype, &tsize);
  PMPI_Get_count(status, *datatype , &recvsize);
  messSize=(double)(tsize * recvsize);
  }
else { mpiPi_msg_warn("MPI_DATATYPE_NULL encountered.  MPI_IN_PLACE not supported.\n");
mpiPi_msg_warn("Values for %s may be invalid for rank %d.\n", &(__func__)[7], mpiPi.rank);}
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl, mpiPi_MPI_Recv, mpiPi.rank, call_stack, start, end, *source, mpiPi.rank);

  mpiPi_update_test(start, end,* source, mpiPi.rank, hndl,
         mpiPi_MPI_Recv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Recv_init, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,mpiPi.rank, * root, hndl,
         mpiPi_MPI_Reduce, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Reduce, mpiPi.rank, call_stack, start, end, mpiPi.rank, * root);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Reduce_scatter, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Request_free, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Rget, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Rget_accumulate, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Rput, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Rsend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Rsend_init, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Scan, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,* root, mpiPi.rank, hndl,
         mpiPi_MPI_Scatter, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,* root, mpiPi.rank, hndl,
         mpiPi_MPI_Scatterv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Scatterv, mpiPi.rank, call_stack, start, end, * root, mpiPi.rank);
...
if ( dur < 0 )
  ...
  //mpiPi_update_test(hndl,mpiPi_MPI_Send,mpiPi.rank, call_stack, start, end, mpiPi.rank, *dest);

  mpiPi_update_test(start, end, mpiPi.rank, *dest, hndl,
         mpiPi_MPI_Send, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Send_init, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,mpiPi.rank, * dest, hndl,
         mpiPi_MPI_Sendrecv, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Sendrecv_replace, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,mpiPi.rank, * dest, hndl,
         mpiPi_MPI_Ssend, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Ssend_init, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Start, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Startall, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Test, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Testall, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Testany, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Testsome, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Topo_test, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Type_commit, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Type_free, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Type_get_contents, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Type_get_envelope, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Unpack, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Wait, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Wait, mpiPi.rank,call_stack, start, end, -1 , -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Waitall, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
  
  //mpiPi_update_test(hndl, mpiPi_MPI_Waitall, mpiPi.rank, call_stack, start, end ,-1, -1);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Waitany, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Waitsome, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_allocate, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_allocate_shared, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_attach, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_complete, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_create, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_create_dynamic, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_detach, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_fence, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_flush, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_flush_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_flush_local, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_flush_local_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_free, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_get_group, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_get_info, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_lock, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_lock_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_post, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_set_info, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_shared_query, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_start, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_sync, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_test, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_unlock, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_unlock_all, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
...
if ( dur < 0 )
  ...
  mpiPi_update_test(start, end,-2, -2, hndl,
         mpiPi_MPI_Win_wait, mpiPi.rank, call_stack, dur, (double)messSize,(double)ioSize,(double)rmaSize);
}
