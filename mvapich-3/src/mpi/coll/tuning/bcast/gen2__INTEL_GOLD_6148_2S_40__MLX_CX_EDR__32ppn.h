    ...
    {                                                                          \
        {32,                                                                   \
         ...
         {                                                                     \
             ...
             {16384, &MPIR_Bcast_intra_scatter_recursive_doubling_allgather},  \
             {32768, &MPIR_Bcast_intra_scatter_recursive_doubling_allgather},  \
             {65536, &MPIR_Knomial_Bcast_inter_node_wrapper_MVP},              \
             {131072, &MPIR_Bcast_intra_scatter_recursive_doubling_allgather}, \
             {262144, &MPIR_Bcast_intra_scatter_recursive_doubling_allgather}, \
...
#define GEN2__INTEL_GOLD_6148_2S_40__MLX_CX_EDR__32PPN_CNT 3
