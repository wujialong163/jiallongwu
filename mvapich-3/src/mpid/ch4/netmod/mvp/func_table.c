...
MPIDI_NM_funcs_t MPIDI_NM_mvp_funcs = {
    ...
    .mpi_comm_commit_post_hook = MPIDI_MVP_mpi_comm_commit_post_hook,
...
MPIDI_NM_funcs_t MPIDI_NM_mvp_funcs = {
    .mpi_init = MPIDI_MVP_mpi_init_hook,
...
MPIDI_NM_native_funcs_t MPIDI_NM_mvp_native_funcs = {
    .mpi_send = MPIDI_MVP_mpi_send,
    .send_coll = MPIDI_NM_send_coll,
    .mpi_ssend = MPIDI_NM_mpi_ssend,
    .mpi_isend = MPIDI_MVP_mpi_isend,
    .isend_coll = MPIDI_NM_isend_coll,
    .mpi_issend = MPIDI_NM_mpi_issend,
    .mpi_cancel_send = MPIDI_NM_mpi_cancel_send,
    .mpi_recv = MPIDI_MVP_mpi_recv,
    .mpi_irecv = MPIDI_MVP_mpi_irecv,
    .mpi_imrecv = MPIDI_NM_mpi_imrecv,
    .mpi_cancel_recv = MPIDI_MVP_mpi_cancel_recv,
