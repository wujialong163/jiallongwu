...
int scr_hash_util_set_bytecount(scr_hash *hash, const char *key,
                                unsigned long count);
...
int scr_hash_util_set_unsigned_long(scr_hash *hash, const char *key,
                                    unsigned long value);
...
int scr_hash_util_get_bytecount(const scr_hash *hash, const char *key,
                                unsigned long *val);
...
int scr_hash_util_get_unsigned_long(const scr_hash *hash, const char *key,
                                    unsigned long *value);

int scr_hash_util_get_str(const scr_hash *hash, const char *key, char **value);

int scr_hash_util_get_int64(const scr_hash *hash, const char *key,
                            int64_t *value);

int scr_hash_util_get_double(const scr_hash *hash, const char *key,
                             double *value);
