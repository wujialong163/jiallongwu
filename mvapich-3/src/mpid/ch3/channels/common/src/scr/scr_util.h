...
/* pass address of pointer to be freed, frees memory if not NULL and sets
 * pointer to NULL */
...
int scr_pack_uint16_t(void *buf, size_t buf_size, size_t *buf_pos,
                      uint16_t val);

/* pack an unsigned 32 bit value to specified buffer in network order */
int scr_pack_uint32_t(void *buf, size_t buf_size, size_t *buf_pos,
                      uint32_t val);

/* pack an unsigned 64 bit value to specified buffer in network order */
int scr_pack_uint64_t(void *buf, size_t buf_size, size_t *buf_pos,
                      uint64_t val);
