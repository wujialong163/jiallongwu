    ...
    {                                                                          \
        {                                                                      \
            ...
            {                                                                  \
                ...
                {256, &MPIR_Bcast_intra_scatter_recursive_doubling_allgather}, \
                {512, &MPIR_Bcast_intra_scatter_recursive_doubling_allgather}, \
                {1024,                                                         \
...
#define GEN2__INTEL_GOLD_6148_2S_40__MLX_CX_EDR__4PPN_CNT 3
