...
void MPID_Segment_pack_device(MPIR_Segment *segp, MPI_Aint first,
        MPI_Aint *lastp, MPIR_Datatype *dt_ptr, void *streambuf);
void MPID_Segment_unpack_device(MPIR_Segment *segp, MPI_Aint first,
        MPI_Aint *lastp, MPIR_Datatype *dt_ptr, void *inbuf);
#endif
