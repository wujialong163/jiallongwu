...
/* opens specified file and waits on for an exclusive lock before returning the
 * file descriptor */
...
/* reliable read from opened file descriptor (retries, if necessary, until hard
 * error) */
...
/* write to an array of open files with known filesizes and treat them as one
 * single large file */
