 ...
 * id and a rank */
int scr_filemap_add_file(scr_filemap *map, int dset, int rank,
                         const char *file);
...
/* TODO: must free ranks list when done with it */
int scr_filemap_list_ranks_by_dataset(const scr_filemap *map, int id, int *n,
                                      int **v);

/* given a filemap, a dataset id, and a rank, return the number of files and a
 * list of the filenames */
/* TODO: must free files list when done with it */
int scr_filemap_list_files(const scr_filemap *map, int dset, int rank,
...
int scr_filemap_have_rank_by_dataset(const scr_filemap *map, int dset,
                                     int rank);
